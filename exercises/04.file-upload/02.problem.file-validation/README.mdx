...
<callout-info class="aside">
	Note: The `File` class is a browser API and not typically available in
	Node.js. However Remix polyfills this for us (check out{' '}
	<InlineFile file="index.js" /> where we use `installGlobals` from Remix).
</callout-info>
